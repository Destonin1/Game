...
import tipGif from './img/tip.gif'
...
const Game = () => {
    ...
    const createBoardSizeContent = () => {
       return new Promise((resolve) => {
            ...
            const btnImage1 = createBtnImage(board7,'board7x7');
            ...
            const btnImage2 = createBtnImage(board9,'board9x9');
            ...
            const btnImage3 = createBtnImage(board11,'board11x11');
